      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <div className="hidden md:flex space-x-8">
            <Link href="/" className="hover:text-vinfast_light transition font-bold">Trang Chủ</Link>
            <Link href="/products" className="hover:text-vinfast_light transition font-bold">Sản Phẩm</Link>
            <Link href="/price-table" className="hover:text-vinfast_light transition font-bold">Bảng Giá</Link>
            <Link href="/posts" className="hover:text-vinfast_light transition font-bold">Bài Viết</Link>
            <Link href="/contact" className="hover:text-vinfast_light transition font-bold">Liên Hệ</Link>
          </div>
